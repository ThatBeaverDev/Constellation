...
class memcfsDriver {
	...
	writeFolder(directory, usr = "root", fs, volGUID) {
	...
	deleteFile(directory, username = "root", fs, volGUID) {
		const obj = getDirInfo(directory)
	...
	deleteFolder(directory, username = "root", fs, volGUID) {
	...
	readFile(directory, attribute = "contents", username = "root", fs, volGUID) {
	...
	listFolder(directory, username = "root", fs, volGUID) {
		if (fs == undefined) {
			console.debug(fs)
	...
	folderPermissions(directory, username = "root", fs, volGUID) {
		try {
			if (directory == "/") {
