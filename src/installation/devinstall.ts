...
export default async function devinstall(ConstellationKernel: ConstellationKernel) {
	const username = developmentOptions.user.username;
	await ConstellationKernel.security.users.newUser(username, developmentOptions.user.password, {
